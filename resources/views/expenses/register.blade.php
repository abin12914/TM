            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="{{route('expenses.store')}}" method="post" class="form-horizontal">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        ...
                                        <div class="form-group">
                                            <label for="truck_id" class="col-sm-2 control-label"><b style="color: red;">* </b> Truck & Date : </label>
                                            <div class="col-sm-5">
                                        ...
                                        <div class="form-group">
                                            <label for="service_id" class="col-sm-2 control-label"><b style="color: red;">* </b> Service : </label>
                                            <div class="col-sm-10 {{ !empty($errors->first('service_id')) ? 'has-error' : '' }}">
                                                <select class="form-control select2" name="service_id" id="service_id" style="width: 100%;">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label"><b style="color: red;">* </b> Bill Amount : </label>
                                            <div class="col-sm-10 {{ !empty($errors->first('bill_amount')) ? 'has-error' : '' }}">
                                                <input type="text" class="form-control decimal_number_only" name="bill_amount" id="bill_amount" placeholder="Bill amount" value="{{ old('bill_amount') }}" maxlength="9">
