                            ...
                            <div class="box-footer no-padding">
                                <ul class="nav nav-stacked">
                                    ...
                                    <li>
                                        <a href="#">Address
                                            <div style="width: 30%;" class="pull-right">
                                                <div class="external-event bg-blue text-center">{{ $employee->account->accountDetail->address }}</div>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">Phone
                                            <div style="width: 30%;" class="pull-right">
                                                <div class="external-event bg-aqua text-center">{{ $employee->account->accountDetail->phone }}</div>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#">Wage / Monthly Salary / Trip Bata
                                            <div style="width: 30%;" class="pull-right">
                                                <div class="external-event bg-aqua text-center">{{ $employee->wage }}</div>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
