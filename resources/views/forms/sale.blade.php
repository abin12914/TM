...
<div class="form-group">
    ...
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="sale_quantity" id="sale_quantity" placeholder="Measurement/Quantity" value="{{ old('sale_quantity') }} {{ old('sale_measure_type') == 3 ? "readonly" : "" }}">
...
<div class="form-group">
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="sale_discount" id="sale_discount" placeholder="Sale discount" value="{{ !empty(old('sale_discount')) ? old('sale_discount') : 0 }}">
    ...
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="sale_total_bill" id="sale_total_bill" placeholder="Total sale bill" value="{{ old('sale_total_bill') }}" readonly>
