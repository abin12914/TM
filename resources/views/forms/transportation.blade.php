<div class="form-group">
    ...
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control decimal_number_only datepicker_reg" name="transportation_date" id="transportation_date" placeholder="Transportation date" value="{{ old('transportation_date') }}">
...
<div class="form-group">
    <div class="col-sm-6">
        ...
        <select class="form-control select2" name="source_id" id="source_id" tabindex="8" style="width: 100%;">
    ...
    <div class="col-sm-6">
        ...
        <select class="form-control select2" name="destination_id" id="destination_id" tabindex="8" style="width: 100%;">
...
<div class="form-group">
    <div class="col-sm-6">
        ...
        <select class="form-control select2" name="contractor_account_id" id="contractor_account_id" tabindex="8" style="width: 100%;">
    ...
    <div class="col-sm-6">
        ...
        <select class="form-control select2" name="rent_type" id="rent_type" tabindex="8" style="width: 100%;">
...
<div class="form-group">
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="rent_measurement" id="rent_measurement" placeholder="Measurement" value="{{ old('rent_type') == 3 ? 1 : old('rent_measurement') }}" {{ old('rent_type') == 3 ? "readonly" : "" }}>
    ...
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="rent_rate" id="rent_rate" placeholder="Rent rate" value="{{ old('rent_rate') }}">
...
<div class="form-group">
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="total_rent" id="total_rent" placeholder="Total rent" value="{{ old('total_rent') }}" readonly>
    ...
    <div class="col-sm-6">
        ...
        <select class="form-control select2" name="material_id" id="material_id" tabindex="8" style="width: 100%;">
...
<div class="form-group">
    <div class="col-sm-6">
        ...
        <select class="form-control select2" name="employee_id" id="employee_id" tabindex="8" style="width: 100%;">
    ...
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="employee_wage" id="employee_wage" placeholder="Driver bata" value="{{ old('employee_wage') }}">
