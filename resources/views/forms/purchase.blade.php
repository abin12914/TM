...
<div class="form-group">
    ...
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="purchase_quantity" id="purchase_quantity" placeholder="Measurement/Quantity" value="{{ old('purchase_measure_type') == 3 ? 1 : old('purchase_quantity') }}" {{ old('purchase_measure_type') == 3 ? "readonly" : "" }}>
...
<div class="form-group">
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="purchase_discount" id="purchase_discount" placeholder="Purchase discount" value="{{ !empty(old('purchase_discount')) ? old('purchase_discount') : 0 }}">
    ...
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control decimal_number_only" name="purchase_total_bill" id="purchase_total_bill" placeholder="Total purchase bill" value="{{ old('purchase_total_bill') }}" readonly>
