            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="{{route('truck.cert.update', $truck->id)}}" method="post" class="form-horizontal" autocomplete="off">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        ...
                                        <div class="form-group">
                                            <label for="service_id" class="col-md-3 control-label"><b style="color: red;">* </b> Certificate : </label>
                                            <div class="col-md-9 {{ !empty($errors->first('service_id')) ? 'has-error' : '' }}">
                                                <select class="form-control select2" name="service_id" id="service_id" style="width: 100%;" tabindex="6">
                                                    ...
                                                    <option value="1" {{ (old('service_id') == 1) ? 'selected' : '' }}>Insurance Certificate</option>
                                                    <option value="2" {{ (old('service_id') == 2) ? 'selected' : '' }}>Tax Certificate</option>
                                                    <option value="3" {{ (old('service_id') == 3) ? 'selected' : '' }}>Fitness Certificate</option>
                                                    <option value="4" {{ (old('service_id') == 4) ? 'selected' : '' }}>Permit Certificate</option>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"><b style="color: red;">* </b> Bill Amount & Validity : </label>
