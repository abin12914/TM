                                    ...
                                    <div class="col-md-11">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div class="col-sm-2 {{ !empty($errors->first('reg_number_region_code')) ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-sm-2 {{ !empty($errors->first('reg_number_unique_alphabet')) ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-sm-2 {{ !empty($errors->first('reg_number_unique_digit')) ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-sm-4 {{ !empty($errors->first('reg_number')) ? 'has-error' : '' }}">
