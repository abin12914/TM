        ...
        <div class="row  no-print">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-header">
                        <form action="{{ route('supply.index') }}" method="get" class="form-horizontal">
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="col-sm-3 {{ !empty($errors->first('from_date')) ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3 {{ !empty($errors->first('to_date')) ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3 {{ !empty($errors->first('contractor_account_id')) ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3 {{ !empty($errors->first('truck_id')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-3 {{ !empty($errors->first('source_id')) ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3 {{ !empty($errors->first('destination_id')) ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3 {{ !empty($errors->first('material_id')) ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3 {{ !empty($errors->first('no_of_records')) ? 'has-error' : '' }}">
